...
/*							if(this.options.notOutDay){
								var now2 = new Date();
								var now = new Date(now2.getFullYear(), now2.getMonth(), now2.getDate(),
										0, 0, 0, 0);
								if(now>this.viewDate.valueOf()){
									$.vAlert("不能选择过期时间!"); 
									return ;
								}
							}*/
/*							if(this.options.maxDay){
								var now2 = new Date();
								var now = new Date(now2.getFullYear(), now2.getMonth(), now2.getDate(),
										0, 0, 0, 0);
								if(this.viewDate.valueOf()-now>86400000*this.options.maxDay){
									$.vAlert("只能选择"+this.options.maxDay+"天以内的时间!"); 
									return ;
								}
							}*/
							this.fill();
